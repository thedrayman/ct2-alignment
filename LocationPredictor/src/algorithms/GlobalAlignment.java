...
//		String locationSequence = reader.getLocationSequence().toString();
//		
//		System.out.println(locationSequence);
//		System.out.println(locationSequence.length());
//		
//		inputString1 = locationSequence.substring(0, 1549);
//		inputString2 = locationSequence.substring(1550, 1557);
		
		inputString1 = "GCATGCU";
		inputString2 = "GATTACA";
