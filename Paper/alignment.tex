...
Let us assume that the exctract from a .csv file consists of unsorted data like shown in Table \ref{fig:csv}.

\begin{enumerate}
	\item First, the data sets are sorted by the timestamp and reduced to two columns, like presented in Table \ref{fig:csv_sorted}. 
