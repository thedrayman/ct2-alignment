...
Nowadays, almost anybody using a mobile device with a GPS (Global Positioning System) on-board. 
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.49\textwidth]{images/Original_Graph.pdf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.49\textwidth]{images/30Min_Graph.pdf}
	\caption{Predicted values from the summerized 30 Minutes sequence}
	\label{fig:diagram_test}
\end{figure}
