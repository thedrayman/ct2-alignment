...
\begin{figure}
	...
	\caption{Example of Waterman-Smith algorithm\cite{ibm}}
...
In Figure \ref{fig:watermansmith} sind zwei Sequenzen "{}GCCCTAGCG"{} und "{}GCGCAATG"{} gegeben, die zusammen eine Matrix bilden. 
