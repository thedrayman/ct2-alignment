...
Dieser Algorithmus ist im Gegensatz zum Needleman-Wunsch-Algorithmus und Hirschbergalgorithmus ist in der Lage das lokale Optimum zu finden. Dies hat den Vorteil, das lokale Übereinstimmungen nicht wie bei einer globalen Betrachtung übersehen werden können.
...
Im Gegensatz zu unseren Ansatz liefert dieses Clustering keine optimale Lösung, sondern führt eine Reduktion der Daten durch und ermöglicht somit die Verwendung auf Leistungsschwachen Geräten.
